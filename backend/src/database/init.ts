...
try {
  ...
  if (!hasIsRegistered) {
    ...
    logger.info('✅ Added is_registered column to users table');
  }
  ...
  const addInviteColumn = (name: string, sqlType: string) => {
    ...
    if (!exists) {
      ...
      logger.info(`✅ Added ${name} column to team_invites table`);
    }
  };
  ...
  const refreshedPostColumns = db.pragma('table_info(team_posts)') as Array<{ name: string }>;
  const addPostColumn = (name: string, sqlType: string) => {
    if (!refreshedPostColumns.some((col) => col.name === name)) {
      db.exec(`ALTER TABLE team_posts ADD COLUMN ${name} ${sqlType}`);
      logger.info(`Added ${name} column to team_posts table`);
    }
  };
  ...
  if (!hasSeriesId) {
    ...
    logger.info('Added series_id column to events table');
  }
  ...
  if (!hasRsvpDeadline) {
    ...
    logger.info('✅ Added rsvp_deadline column to events table');
  }
  ...
  const addEventColumn = (name: string, sqlType: string) => {
    ...
    if (!exists) {
      ...
      logger.info(`✅ Added ${name} column to events table`);
    }
  };
  ...
  if (!hasCalendarToken) {
    ...
    logger.info('✅ Added calendar_token column to teams table');
  }
  ...
  if (hasCalendarTokenAfterMigration) {
    try {
      ...
      logger.warn('⚠️ Calendar token migration warning:', calendarTokenMigrationError);
    }
  }
  ...
  if (!hasFussballDeId) {
    ...
    logger.info('✅ Added fussballde_id column to teams table');
  }
  ...
  if (!hasDefaultResponse) {
    ...
    logger.info('✅ Added default_response column to teams table');
  }
  ...
  if (!hasDefaultRsvpDeadlineHours) {
    ...
    logger.info('✅ Added default_rsvp_deadline_hours column to teams table');
  }
  ...
  if (!hasDefaultRsvpDeadlineHoursTraining) {
    ...
    logger.info('✅ Added default_rsvp_deadline_hours_training column to teams table');
  }
  ...
  if (!hasDefaultRsvpDeadlineHoursMatch) {
    ...
    logger.info('✅ Added default_rsvp_deadline_hours_match column to teams table');
  }
  ...
  if (!hasDefaultRsvpDeadlineHoursOther) {
    ...
    logger.info('✅ Added default_rsvp_deadline_hours_other column to teams table');
  }
  ...
  if (!hasDefaultArrivalMinutes) {
    ...
    logger.info('✅ Added default_arrival_minutes column to teams table');
  }
  ...
  if (!hasDefaultArrivalMinutesTraining) {
    ...
    logger.info('✅ Added default_arrival_minutes_training column to teams table');
  }
  ...
  if (!hasDefaultArrivalMinutesMatch) {
    ...
    logger.info('✅ Added default_arrival_minutes_match column to teams table');
  }
  ...
  if (!hasDefaultArrivalMinutesOther) {
    ...
    logger.info('✅ Added default_arrival_minutes_other column to teams table');
  }
  ...
  if (!hasDefaultDurationMinutes) {
    ...
    logger.info('✅ Added default_duration_minutes column to teams table');
  }
  ...
  if (!hasDefaultDurationMinutesTraining) {
    ...
    logger.info('✅ Added default_duration_minutes_training column to teams table');
  }
  ...
  if (!hasDefaultDurationMinutesMatch) {
    ...
    logger.info('✅ Added default_duration_minutes_match column to teams table');
  }
  ...
  if (!hasDefaultDurationMinutesOther) {
    ...
    logger.info('✅ Added default_duration_minutes_other column to teams table');
  }
  ...
  if (!hasHomeVenues) {
    ...
    logger.info('✅ Added home_venues column to teams table');
  }
  ...
  if (!hasDefaultHomeVenueName) {
    ...
    logger.info('✅ Added default_home_venue_name column to teams table');
  }
  ...
  if (!hasInvitedUserId) {
    ...
    logger.info('✅ Added invited_user_id column to trainer_invites table');
  }
  ...
  if (!hasOrganizationShortName) {
    ...
    logger.info('✅ Added short_name column to organizations table');
  }
  ...
  if (!hasOrganizationAccentColor) {
    ...
    logger.info('✅ Added accent_color column to organizations table');
  }
  ...
  if (!hasCustomTeamName) {
    ...
    logger.info('✅ Added trainer_custom_team_name column to team_members table');
  }
